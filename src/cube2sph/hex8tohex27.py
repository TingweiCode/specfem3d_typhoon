...
print_every = 10000
print("\nconverting HEX8 to HEX27 elements...")
print('counting faces...')
for line in tqdm.tqdm(mesh_nodes):
    i_element = line[0]
    node = line
    this_element_face = []
...
mesh27_nodes = np.concatenate((mesh_nodes, element_edge + edge_center_offset, element_face + face_center_offset, np.reshape(element_center_coords['inode'], (n_element, 1))), axis=1)
...
abs_nodes = np.concatenate((np.reshape(element_abs, (n_abs, 1)), mesh27_nodes[np.ix_(element_abs - 1, idx_bottom)]), axis=1)
...
abs_nodes = np.loadtxt(fname=abs_fn, dtype=int, skiprows=1)
element_abs = abs_nodes[:, 0]
abs_nodes = np.concatenate((np.reshape(element_abs, (n_abs, 1)), mesh27_nodes[np.ix_(element_abs - 1, idx_xmax)]), axis=1)
...
abs_nodes = np.loadtxt(fname=abs_fn, dtype=int, skiprows=1)
element_abs = abs_nodes[:, 0]
abs_nodes = np.concatenate((np.reshape(element_abs, (n_abs, 1)), mesh27_nodes[np.ix_(element_abs - 1, idx_xmin)]), axis=1)
...
abs_nodes = np.loadtxt(fname=abs_fn, dtype=int, skiprows=1)
element_abs = abs_nodes[:, 0]
abs_nodes = np.concatenate((np.reshape(element_abs, (n_abs, 1)), mesh27_nodes[np.ix_(element_abs - 1, idx_ymax)]), axis=1)
...
abs_nodes = np.loadtxt(fname=abs_fn, dtype=int, skiprows=1)
element_abs = abs_nodes[:, 0]
abs_nodes = np.concatenate((np.reshape(element_abs, (n_abs, 1)), mesh27_nodes[np.ix_(element_abs - 1, idx_ymin)]), axis=1)
...
abs_nodes = np.loadtxt(fname=abs_fn, dtype=int, skiprows=1)
element_abs = abs_nodes[:, 0]
abs_nodes = np.concatenate((np.reshape(element_abs, (n_abs, 1)), mesh27_nodes[np.ix_(element_abs - 1, idx_top)]), axis=1)
